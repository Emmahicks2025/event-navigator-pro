  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'card-gradient': 'linear-gradient(135deg, hsl(222 30% 12%) 0%, hsl(222 30% 8%) 100%)',
        'glow-gradient': 'radial-gradient(circle at center, hsl(var(--primary) / 0.2) 0%, transparent 50%)',
      },
      boxShadow: {
